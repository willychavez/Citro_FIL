...
dlmwrite ('EspectrosMMO_exclusao1_ASS_DiasAgrupados_FIL.dat', Espectros_1, 'delimiter','\t', 'precision',4)
dlmwrite ('EspectrosMMO_exclusao1_SADIA_DiasAgrupados_FIL.dat', Espectros_2, 'delimiter','\t', 'precision',4)
dlmwrite ('EspectrosMMO_exclusao1_SINT_DiasAgrupados_FIL.dat', Espectros_3, 'delimiter','\t', 'precision',4)
...
fid = (fopen('FIL_Agrupados.arff','w'));
